...
\usepackage{biblatex}
%\usepackage[backend=biber, citestyle=phys]{biblatex}
...
\include{chap1_intro}
\include{chap2_torsion_model}
\include{chap3_aromaticity}
\include{chap4_conclusion}
%\include{chap1}
%\include{chap2}

\appendix
\include{appendix_tor_model}
\include{appendix_aroma}
